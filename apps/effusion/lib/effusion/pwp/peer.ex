defmodule Effusion.PWP.Peer do
  ...
  def execute(
    ...
    %PeerHasPiece{
      ...
      info_hash: info_hash,
      index: index,
      bitfield: IntSet.put(bitfield, index)
    }
  end
  ...
  def execute(
    ...
    cond do
      peer_choking ->
        {:error, "Peer is choking us, we cannot send requests"}

      not Enum.member?(bitfield, index) ->
        {:error, "Cannot request a piece the peer does not have"}

      Enum.member?(our_requests, {index, offset, size}) ->
        {:error, "Already requested this piece from this peer"}
  ...
  def apply(
    ...
    %__MODULE__{peer | host: host, port: port}
  end
  ...
  def apply(
    ...
    %__MODULE__{peer | peer_id: peer_id, info_hash: info_hash}
  end
  ...
  def apply(
    ...
    %__MODULE__{peer | peer_choking: true}
  end
  ...
  def apply(
    ...
    %__MODULE__{peer | peer_choking: false}
  end
  ...
  def apply(
    ...
    %__MODULE__{peer | peer_interested: true}
  end
  ...
  def apply(
    ...
    %__MODULE__{peer | peer_interested: false}
  end
  ...
  def apply(
    ...
    %__MODULE__{peer | bitfield: bitfield}
  end
  ...
  def apply(
    ...
    %__MODULE__{peer | bitfield: IntSet.new(Base.decode64!(bitfield))}
  end
  ...
  def apply(
    ...
    %__MODULE__{
      ...
      | our_requests:
          MapSet.delete(
            our_requests,
            {index, offset, Application.fetch_env!(:effusion, :block_size)}
          )
    }
  end
  ...
  def apply(
    ...
    %__MODULE__{peer | am_interested: true}
  end
  ...
  def apply(
    ...
    %__MODULE__{peer | our_requests: MapSet.delete(our_requests, {index, offset, size})}
  end
